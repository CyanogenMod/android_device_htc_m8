...
public:
    ...
    void receiveRecordingFrame(mm_camera_ch_data_buf_t *frame);
...
private:
    ...
    */
    ...
    //friend void do_receive_camframe_callback(mm_camera_ch_data_buf_t* packed_frame, void* HAL_obj);
    ...
    public:
    void receive_camframe_callback(mm_camera_ch_data_buf_t* packed_frame, void* HAL_obj);

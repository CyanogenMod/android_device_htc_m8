...
typedef struct camera_device_ops {
    ...
    */
    ...
    /**
     * HTC MSM8960 devices have these extra functions in their camera HAL
     * We need to add these dummy functions for the HAL to correctly offset
     * the release function
     */
    int (*get_number_of_video_buffers)(struct camera_device *);

    camera_memory_t *(*get_video_buffer)(struct camera_device *, int val);
#endif

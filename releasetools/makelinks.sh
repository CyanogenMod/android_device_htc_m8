...
elif [ -f "/firmware/radio/a7bc0e1.mdt" ]; then
  ln -s /firmware/radio/a7bc0e1.mdt /system/vendor/firmware/mba.mdt
  ln -s /firmware/radio/a7bc0e1.b00 /system/vendor/firmware/mba.b00

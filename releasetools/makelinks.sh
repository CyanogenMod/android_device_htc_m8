...
# Prefer an mba* pair if one exists, if not, find the a7b* pair with the highest "number" unless you're T-Mo
if [ -f "/tmp/mba.mdt" -a $modelid != "0P6B13000" ]; then # Fuck T-Mo
